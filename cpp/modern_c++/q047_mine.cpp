...
# 59 "/usr/include/c++/7/bits/stl_algobase.h" 3
...
# 60 "/usr/include/c++/7/bits/stl_algobase.h" 2 3
...
# 64 "/usr/include/c++/7/deque" 2 3
# 1 "/usr/include/c++/7/bits/stl_deque.h" 1 3
# 63 "/usr/include/c++/7/bits/stl_deque.h" 3
...
#pragma GCC visibility pop
# 64 "/usr/include/c++/7/bits/stl_deque.h" 2 3
...
class dubble_buffer {
public:
    static deque<T> buffer;
    static void put(T const & e) {
        buffer.push_back(e);
    }
    static T const pop() {
        T const tmp = buffer.front();
        buffer.pop_front();
        return tmp;
    }
...
template <>
deque<int> dubble_buffer<int>::buffer;

int main () {
    using db = dubble_buffer<int>;
    db::put(3);
    db::put(5);
    int i = db::pop();
    cout << i << endl;
